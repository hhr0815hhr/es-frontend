...
(function (core) {
    ...
    var DragonBonesFactory = (function (_super) {
        ...
        function DragonBonesFactory() {
            ...
            _this.averageUtils = new core.AverageUtils();
        ...
        DragonBonesFactory.prototype.makeArmature = function (name, fromDragonBonesDataName, playSpeed) {
            ...
            if (armature == null) {
                core.Log.warn("不存在Armature： " + name);
                return null;
            }
            var clock = this.createWorldClock(playSpeed);
            var result = new core.DragonBonesArmature(armature, clock);
            return result;
        };
        /**
         * 创建一个动画（急速模式）
        ...
        DragonBonesFactory.prototype.stop = function () {
            if (this.isPlay) {
                core.App.TimerManager.remove(this.onEnterFrame, this);
                this.isPlay = false;
            }
        };
        /**
        ...
        DragonBonesFactory.prototype.start = function () {
            if (!this.isPlay) {
                this.isPlay = true;
                core.App.TimerManager.doFrame(1, 0, this.onEnterFrame, this);
            }
        };
        return DragonBonesFactory;
    }(core.Singleton));
    core.DragonBonesFactory = DragonBonesFactory;
    __reflect(DragonBonesFactory.prototype, "core.DragonBonesFactory");
})(core || (core = {}));
