...
(function (core) {
    ...
    var DragonBonesArmatureContainer = (function (_super) {
        ...
        DragonBonesArmatureContainer.prototype.play = function (action, playNum) {
            ...
            if (this.actions[action] == null) {
                core.Log.debug("DragonBonesArmatureContainer不存在动作：", action);
                return;
            }
        ...
        DragonBonesArmatureContainer.prototype.remove = function () {
            ...
            if (oldArm) {
                oldArm.stop();
                core.App.DisplayUtils.removeFromParent(oldArm);
        ...
        DragonBonesArmatureContainer.prototype.clear = function () {
            while (this.armatures.length) {
                ...
                core.App.DisplayUtils.removeFromParent(arm);
                arm.destroy();
            }
            this.cacheBones = {};
            this.actions = {};
    ...
    core.DragonBonesArmatureContainer = DragonBonesArmatureContainer;
    __reflect(DragonBonesArmatureContainer.prototype, "core.DragonBonesArmatureContainer");
})(core || (core = {}));
