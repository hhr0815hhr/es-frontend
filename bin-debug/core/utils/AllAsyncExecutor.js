...
(function (core) {
    ...
    var AllAsyncExecutor = (function () {
        ...
        AllAsyncExecutor.prototype.start = function () {
            core.App.ArrayUtils.forEach(this._functions, function (arr) {
                arr[0].call(arr[1]);
            }, this);
        };
        /**
    ...
    core.AllAsyncExecutor = AllAsyncExecutor;
    __reflect(AllAsyncExecutor.prototype, "core.AllAsyncExecutor");
})(core || (core = {}));
