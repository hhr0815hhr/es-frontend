...
(function (core) {
    ...
    var RockerUtils = (function (_super) {
        ...
        RockerUtils.prototype.init = function (moveBg, moveFlag, dealKeyFunc, dealKeyTarget) {
            ...
            this.moveFlagCheckRec = new egret.Rectangle(0, 0, core.App.StageUtils.getWidth() * 0.5, core.App.StageUtils.getHeight());
            ...
            core.App.StageUtils.getStage().addEventListener(egret.TouchEvent.TOUCH_END, this.leaveStateEvent, this);
            core.App.StageUtils.getStage().addEventListener(egret.TouchEvent.TOUCH_MOVE, this.heroMoveEvent, this);
            //键盘控制
            core.App.KeyboardUtils.addKeyDown(this.onKeyDown, this);
            core.App.KeyboardUtils.addKeyUp(this.onKeyUp, this);
        };
        /**
         * 键盘按下处理
         * @param keyCode
        ...
        RockerUtils.prototype.onKeyDown = function (keyCode) {
            switch (keyCode) {
                case core.Keyboard.A:
                    this.keys[0] = -1;
                    this.startCheckKey();
                    break;
                case core.Keyboard.D:
                    this.keys[0] = 1;
                    this.startCheckKey();
                    break;
                case core.Keyboard.W:
                    this.keys[1] = -1;
                    this.startCheckKey();
                    break;
                case core.Keyboard.S:
                    this.keys[1] = 1;
                    this.startCheckKey();
                    break;
                default:
        ...
        RockerUtils.prototype.runMove = function (stageX, stageY) {
            ...
            if (this.moveFlagRec.contains(this.mouseX, this.mouseY)) {
                ...
                var radian = core.App.MathUtils.getRadian2(this.moveFlagX, this.moveFlagY, this.mouseX, this.mouseY);
        ...
        RockerUtils.prototype.startCheckKey = function () {
            if (!this.checkKeying) {
                ...
                core.App.TimerManager.doFrame(1, 0, this.delKeys, this);
            }
        };
        /**
         * 停止检测
        ...
        RockerUtils.prototype.stopCheckKey = function () {
            ...
            this.keys[1] = 0;
            if (this.checkKeying) {
                core.App.TimerManager.remove(this.delKeys, this);
