    ...
    var GuideView = (function (_super) {
        ...
        */
        function GuideView() {
            ...
            _this._bg = new core.GuideMaskBackgroud();
            _this.addChild(_this._bg);
            _this._maskPic = core.StarlingSwfUtils.createS9Image("s9_guide_mask");
            _this.addChild(_this._maskPic);
            _this._textBgPic = core.StarlingSwfUtils.createS9Image("s9_guide_txt");
            core.App.AnchorUtils.setAnchorY(_this._textBgPic, 1);
            _this.addChild(_this._textBgPic);
            _this._handPic = core.StarlingSwfUtils.createImage("img_hand");
            core.App.AnchorUtils.setAnchorX(_this._handPic, 0.5);
            _this.addChild(_this._handPic);
            _this._txt = new egret.TextField();
            _this._txt.size = 26;
            _this._txt.textColor = 0x575757;
            _this._txt.lineSpacing = 4;
            core.App.AnchorUtils.setAnchorY(_this._txt, 0.5);
