...
(function (core) {
    ...
    var BaseProxy = (function () {
        ...
        BaseProxy.prototype.receiveServerMsg = function (key, callbackFunc, callbackObj) {
            core.App.MessageCenter.addListener(key, callbackFunc, callbackObj);
        };
        /**
        ...
        BaseProxy.prototype.removeServerMsg = function (key, callbackFunc, callbackObj) {
            core.App.MessageCenter.removeListener(key, callbackFunc, callbackObj);
        };
        /**
        ...
        BaseProxy.prototype.sendHttpMsg = function (type, paramObj) {
            ...
            core.App.Http.send(type, this.getURLVariables(type, paramObj));
        };
        /**
         * 将参数转换为URLVariables
         * @param t_type
        ...
        BaseProxy.prototype.getURLVariables = function (t_type, t_paramObj) {
            ...
            var variables = new egret.URLVariables("data=" + param + "&h=" + core.App.ProxyUserFlag);
            return variables;
        };
        return BaseProxy;
    }());
