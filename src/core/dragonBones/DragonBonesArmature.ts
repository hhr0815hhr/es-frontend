module core {
    ...
    export class DragonBonesArmature extends egret.DisplayObjectContainer {
         ...
         */
        public getBoneDisplay(boneName: string): egret.DisplayObject {

            return this.getArmature().getSlot(boneName).display;
        }
        ...
        public changeBone(boneName: string, displayObject: egret.DisplayObject): void {
            ...
            this.getArmature().getSlot(boneName).display = displayObject;
            // if (bone) {
